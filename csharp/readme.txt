...
Проект ObserveRfidTids зависит от сборок RfidCenter.Basic.dll, RfidCenter.Devices.dll, RfidBus.Primitives.dll, расположенных по месту установки Шины RFID, и RfidBus.Serializers.Pb.dll, расположенной в поддиректории «serializers» в корневой директории Шины RFID.